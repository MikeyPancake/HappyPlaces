...
data class HappyPlaceModel (
    ...
    // Allows you to pass the model to the intent. Parcelable is faster than Serializable
    // Serializable requires less code but is lease performing. When using serializable, you do not need the code below
    ) : Parcelable {
